...
public class FacadeController {
	...
	public String creaOggettiTest(Model model) {
		...
		s5.setNome("Singola");
		s5.setDescrizione("Stanza singola vista Duomo");
		s5.setNumero(7);
		...
		sv5.setNome("Vasca da bagno");
		sv5.setDescrizione("Vasca da bagno");
